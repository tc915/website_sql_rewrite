...
const Services = () => {
    ...
    return (
        <>
            <motion.div className={`pt-44 tablet:pt-12 flex xlMobile:flex-col lgMobile:flex-col mdMobile:flex-col h-[200rem] tablet:h-[140rem] ${darkMode ? 'bg-[#131313]' : 'bg-white'}`}
                variants={fadeInVariants}
                initial="initial"
                animate="animate"
            >
                <div className="w-1/2 xlMobile:w-[32rem] lgMobile:w-full mdMobile:w-full flex flex-col p-5 tablet:p-0 pl-24 tablet:pl-6 xlMobile:pl-6 lgMobile:pl-4 mdMobile:pl-4">
                    <div className="h-[30rem]">
                        <h1 className="text-transparent font-md text-8xl tablet:text-4xl xlMobile:text-7xl lgMobile:text-6xl mdMobile:text-6xl ml-20 tablet:ml-12 xlMobile:ml-6 lgMobile:ml-6 mdMobile:ml-6 pt-20 bg-gradient-to-r from-[#facc22] to-[#FF7F11] inline-block bg-clip-text font-ruda">Services</h1>
                        <p className={`mt-6 font-shanti px-20 tablet:px-12 xlMobile:px-6 lgMobile:px-6 mdMobile:px-6 text-2xl tablet:text-[1rem] tablet:leading-[1.5rem] xlMobile:text-2xl lgMobile:text-xl mdMobile:text-xl ${darkMode ? 'text-white' : 'text-black'}`}>
                    ...
                    <div className="w-full h-[45rem] tablet:h-[30rem] xlMobile:h-[54rem] p-24 tablet:p-6 xlMobile:p-6 xlMobile:px-10 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative xlMobile:mt-32 lgMobile:mt-10 mdMobile:mt-10">
                        <h2 className="text-7xl tablet:text-2xl xlMobile:text-5xl lgMobile:text-2xl mdMobile:text-2xl font-md tracking-widest font-hind">Enclosure Design</h2>
                    ...
                    <div className="w-full h-[34rem] tablet:h-[30rem] xlMobile:h-[52rem] lgMobile:h-[45rem] mdMobile:h-[45rem] mt-10 p-24 tablet:p-6 xlMobile:p-6 xlMobile:px-10 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-5xl tablet:text-2xl xlMobile:text-4xl lgMobile:text-2xl mdMobile:text-2xl font-md tracking-widest font-hind">Garmin / Simrad Custom GUI</h2>
                    ...
                    <div className="w-full h-[38rem] tablet:h-[30rem] xlMobile:h-[48rem] mt-10 p-24 tablet:p-6 xlMobile:p-6 xlMobile:px-10 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-5xl tablet:text-2xl xlMobile:text-5xl lgMobile:text-2xl mdMobile:text-2xl font-md tracking-widest font-hind">PCB / Electrical Design</h2>
                        <p className="text-white mt-10 text-2xl tablet:text-sm xlMobile:text-2xl lgMobile:text-lg mdMobile:text-lg font-shanti">
                ...
                <div className="w-1/2 tablet:mt-12 xlMobile:w-[30.8rem] lgMobile:w-full mdMobile:w-full p-5 pr-24 tablet:pr-6 xlMobile:pr-0 lgMobile:pr-6 mdMobile:pr-6">
                    <div className="w-full h-[50rem] tablet:h-[35rem] xlMobile:h-[55rem] p-24 tablet:p-6 xlMobile:p-6 xlMobile:px-10 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-9xl tablet:text-5xl xlMobile:text-7xl lgMobile:text-5xl mdMobile:text-5xl font-thin tracking-widest font-hind">R&D</h2>
                        <p className="text-white mt-14 text-xl tablet:text-sm xlMobile:text-2xl lgMobile:text-lg mdMobile:text-lg font-shanti">
                    ...
                    <div className="w-full h-[27.5rem] tablet:h-[35rem] xlMobile:h-[52rem] lgMobile:h-[42rem] mdMobile:h-[42rem] mt-10 p-24 tablet:p-6 xlMobile:p-6 xlMobile:px-10 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-4xl tablet:text-2xl xlMobile:text-5xl lgMobile:text-2xl mdMobile:text-2xl font-md tracking-widest font-hind">Embedded Firmware</h2>
                        <p className="text-white font-shanti mt-8 text-lg tablet:text-sm xlMobile:text-2xl mdMobile:mb-10">
                    ...
                    <div className="w-full h-[45rem] tablet:h-[30rem] xlMobile:h-[45rem] lgMobile:h-[40rem] mdMobile:h-[40rem] mt-10 p-24 tablet:p-6 xlMobile:p-6 xlMobile:px-10 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-7xl tablet:text-2xl xlMobile:text-5xl lgMobile:text-2xl mdMobile:text-2xl font-md tracking-widest font-hind">App Development</h2>
                        <p className="text-white mt-10 text-2xl tablet:text-sm lgMobile:text-lg mdMobile:text-lg font-shanti">
