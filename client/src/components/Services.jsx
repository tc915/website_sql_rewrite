...
const Services = () => {
    ...
    return (
        <>
            <motion.div className={`pt-44 tablet:pt-12 flex lgMobile:flex-col mdMobile:flex-col h-[200rem] tablet:h-[140rem] ${darkMode ? 'bg-[#131313]' : 'bg-white'}`}
            ...
            >
                <div className="w-1/2 lgMobile:w-full mdMobile:w-full flex flex-col p-5 tablet:p-0 pl-24 tablet:pl-6 lgMobile:pl-4 mdMobile:pl-4">
                    ...
                    <div className="w-full h-[34rem] tablet:h-[30rem] lgMobile:h-[45rem] mdMobile:h-[45rem] mt-10 p-24 tablet:p-6 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                    ...
                    <div className="w-full h-[38rem] tablet:h-[30rem] mt-10 p-24 tablet:p-6 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-5xl tablet:text-2xl lgMobile:text-2xl mdMobile:text-2xl font-md tracking-widest">PCB / Electrical Design</h2>
                        <p className="text-white mt-10 text-2xl tablet:text-sm lgMobile:text-lg mdMobile:text-lg">
                ...
                <div className="w-1/2 tablet:mt-12 lgMobile:w-full mdMobile:w-full p-5 pr-24 tablet:pr-6 lgMobile:pr-6 mdMobile:pr-6">
                    <div className="w-full h-[50rem] tablet:h-[35rem] p-24 tablet:p-6 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-9xl tablet:text-5xl lgMobile:text-5xl mdMobile:text-5xl font-thin tracking-widest">R&D</h2>
                        <p className="text-white mt-14 text-xl tablet:text-sm lgMobile:text-lg mdMobile:text-lg">
                    ...
                    <div className="w-full h-[27.5rem] tablet:h-[35rem] lgMobile:h-[42rem] mdMobile:h-[42rem] mt-10 p-24 tablet:p-6 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-4xl tablet:text-2xl lgMobile:text-2xl mdMobile:text-2xl font-md tracking-widest">Embedded Firmware</h2>
                        <p className="text-white mt-8 text-lg tablet:text-sm mdMobile:mb-10">
                    ...
                    <div className="w-full h-[45rem] tablet:h-[30rem] lgMobile:h-[40rem] mdMobile:h-[40rem] mt-10 p-24 tablet:p-6 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative">
                        <h2 className="text-7xl tablet:text-2xl lgMobile:text-2xl mdMobile:text-2xl font-md tracking-widest">App Development</h2>
                        <p className="text-white mt-10 text-2xl tablet:text-sm lgMobile:text-lg mdMobile:text-lg">
