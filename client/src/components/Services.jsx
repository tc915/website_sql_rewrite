        ...
        <>
            ...
            >
                <div className="w-1/2 lgMobile:w-full mdMobile:w-full flex flex-col p-5 tablet:p-0 pl-24 tablet:pl-6 lgMobile:pl-4 mdMobile:pl-4">
                    ...
                    <div className="w-full h-[45rem] tablet:h-[3rem] p-24 tablet:p-6 lgMobile:p-6 mdMobile:p-6 text-white bg-[#1e1e1e] flex flex-col justify-center relative lgMobile:mt-10 mdMobile:mt-10">
