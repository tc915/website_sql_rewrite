        ...
        <div className={`pt-44 tablet:pt-24 ${darkMode ? 'text-white bg-[#131313]' : 'text-black bg-white'}`}>
            ...
            <div className="flex xlMobile:flex-col lgMobile:flex-col mdMobile:flex-col h-[36rem] tablet:h-[25rem]">
                <div className="w-1/2 xlMobile:w-full lgMobile:w-full mdMobile:w-full">
                    ...
                    <h1 className="text-6xl tablet:text-3xl xlMobile:text-[2.65rem] lgMobile:text-3xl mdMobile:text-3xl mt-4 xlMobile:mt-10 ml-[15rem] tablet:ml-12 xlMobile:ml-12 lgMobile:ml-6 mdMobile:ml-6 font-ruda">Embedded Firmware</h1>
                    ...
                    <Link to={'/contact'}>
                        <motion.button className="ml-[15rem] tablet:ml-12 xlMobile:ml-12 lgMobile:ml-6 mdMobile:ml-6 mt-6 xlMobile:mt-12 px-16 tablet:px-10 py-4 tablet:py-2 bg-[#FF7F11] text-white rounded-full text-[1.2em] tablet:text-sm xlMobile:text-3xl font-semibold font-hind"
            ...
            <div className="w-full h-[36rem] mdMobile:h-[42rem] mt-[6rem] tablet:mt-20 xlMobile:mt-56 mb-[3rem] xlMobile:mb-[35rem] lgMobile:mb-[20rem] mdMobile:mb-[20rem] flex xlMobile:flex-col lgMobile:flex-col mdMobile:flex-col">
                ...
                <div className="w-1/2 xlMobile:w-full lgMobile:w-full mdMobile:w-full">
                    <h1 className="text-5xl tablet:text-3xl lgMobile:text-3xl mdMobile:text-3xl mt-24 mr-[15rem] tablet:mr-12 xlMobile:mr-12 lgMobile:mr-6 mdMobile:mr-6 ml-10 xlMobile:ml-12 lgMobile:ml-6 mdMobile:ml-6 font-hind">The Value of Embedded Firmware</h1>
