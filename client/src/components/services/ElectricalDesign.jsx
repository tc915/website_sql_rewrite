        ...
        <div className={`pt-44 ${darkMode ? 'text-white bg-[#131313]' : 'text-black bg-white'}`}>
            ...
            <div className="flex lgMobile:flex-col mdMobile:flex-col h-[36rem]">
                <div className="w-1/2 lgMobile:w-full mdMobile:w-full">
                    ...
                    <h1 className="text-6xl lgMobile:text-3xl mdMobile:text-3xl mt-4 ml-[15rem] lgMobile:ml-6 mdMobile:ml-6">Electrical Design</h1>
            ...
            <div className="w-full h-[36rem] mt-[6rem] mb-[3rem] lgMobile:mb-[20rem] mdMobile:mb-[20rem] flex lgMobile:flex-col mdMobile:flex-col">
                ...
                <div className="w-1/2 lgMobile:w-full mdMobile:w-full">
                    <h1 className="text-6xl lgMobile:text-3xl mdMobile:text-3xl mt-20 mr-[15rem] lgMobile:mr-6 mdMobile:mr-6 ml-10 lgMobile:ml-6 mdMobile:ml-6">The Value of Electrical Design</h1>
