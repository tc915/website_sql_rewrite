        ...
        <div className={`pt-44 lgMobile:overflow-x-hidden ${darkMode ? 'text-white bg-[#131313]' : 'text-black bg-white'}`}>
            ...
            <div className="flex lgMobile:flex-col h-[36rem]">
                <div className="w-1/2 lgMobile:w-full">
                    ...
                    <h1 className="text-6xl lgMobile:text-3xl mt-4 ml-[15rem] lgMobile:ml-6">App Development</h1>
            ...
            <div className="w-full h-[36rem] mt-[6rem] mb-[3rem] lgMobile:mb-[20rem] flex lgMobile:flex-col">
                ...
                <div className="w-1/2 lgMobile:w-full">
                    <h1 className="text-6xl lgMobile:text-3xl mt-20 mr-[15rem] lgMobile:mr-6 ml-10 lgMobile:ml-6">The Value of App Development</h1>
