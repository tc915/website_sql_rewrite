                ...
                <motion.div className={`w-full mdMobile:w-[30rem] lgMobile:w-[30rem] overflow-hidden`}>
                    ...
                    <div className="w-full h-[20rem] absolute -mt-[52rem] lgMobile:-mt-[36rem] lgMobile:w-[85%] text-white pl-[9.5rem] xsm:pl-[7rem] xxsm:pl-[7rem] laptop:pl-[7rem] smLaptop:pl-[5rem] tablet:pl-[5rem] lgMobile:pl-[3rem] mdMobile:pl-[3rem] mdMobile:pr-[5rem] mdMobile:w-full mdMobile:-mt-[30rem]">
                        ...
                        <div className="flex mt-16 lgMobile:mt-8 lgMobile:flex-col">
                            <Link to={'/contact'}><motion.button className="py-2 px-10 lgMobile:py-2 lgMobile:px-8 mdMobile:px-8 text-xl lgMobile:text-xl mdMobile:text-[0.8rem] font-semibold rounded-full bg-[#FF7F11]"
                                variants={buttonVariants}
                                whileHover="hover"
                                whileTap="click"
                            >Start a Project</motion.button></Link>
                            <Link to={'/products'}><motion.button className="py-2 px-6 lgMobile:py-2 lgMobile:px-8 mdMobile:px-8 ml-8 lgMobile:ml-0 lgMobile:mt-6 text-xl lgMobile:text-lg mdMobile:text-[0.8rem] font-semibold rounded-full border-2 border-white"
                                variants={buttonVariants}
                                whileHover="hover"
                                whileTap="click"
