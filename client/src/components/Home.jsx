            ...
            >
                <motion.div className={`w-full mdMobile:w-[30rem] lgMobile:w-[30rem] overflow-hidden`}>
                    ...
                    <div className="w-full h-screen flex lgMobile:flex-col-reverse mdMobile:flex-col-reverse lgMobile:mb-32 mdMobile:mb-32 lgMobile:-mt-[15rem] mdMobile:-mt-[15rem]">
                        ...
                        <div className={`w-1/2 lgMobile:w-full mdMobile:w-[90%] flex flex-col justify-center pl-32 lgMobile:pl-10 lgMobile:mb-10 mdMobile:mb-10 ${darkMode ? 'text-white' : 'text-black'}`}>
