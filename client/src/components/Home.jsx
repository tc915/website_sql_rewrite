        ...
        <>
            ...
            <div className={`fixed top-0 left-0 w-full h-screen z-[99] bg-black/50 justify-center items-center ${editThinkTank ? 'flex' : 'hidden'} lgMobile:text-sm mdMobile:text-sm`}>
                <div className={`${darkMode ? 'bg-[#131313] text-white' : 'bg-white text-black'} w-[50rem] tablet:w-[80%] xlMobile:w-[90%] h-[33rem] tablet:h-[80%] xlMobile:h-[70%] relative flex flex-col items-center rounded-xl overflow-y-auto`}>
                    ...
                    <TextAreaAutosize className={`bg-transparent resize-none w-2/3 border-2 rounded-xl mt-4 p-4 text-xl font-shanti tablet:text-lg tablet:min-h-[8rem] xlMobile:min-h-[8rem] lgMobile:text-lg mdMobile:text-lg ${darkMode ? 'outline-white' : ''}`} required placeholder="Message"
                        value={thinkTankText}
            ...
            >
                <motion.div className={`w-full xlMobile:w-full mdMobile:w-[30rem] lgMobile:w-[30rem] xlMobile:overflow-hidden lgMobile:overflow-hidden mdMobile:overflow-hidden`}>
                    ...
                    <div className="w-full h-[20rem] absolute -mt-[52rem] xlMobile:-mt-[35rem] lgMobile:-mt-[36rem] lgMobile:w-[85%] text-white pl-[9.5rem] xsm:pl-[7rem] xxsm:pl-[7rem] laptop:pl-[7rem] smLaptop:pl-[5rem] tablet:pl-[5rem] xlMobile:pl-[3rem] xlMobile:pr-[2rem] lgMobile:pl-[3rem] mdMobile:pl-[3rem] mdMobile:pr-[5rem] mdMobile:w-full mdMobile:-mt-[30rem]">
                        <h1 className="font-[900] text-5xl xl:mt-36 lg:mt-44 md:mt-[15rem] md:text-5xl sm:mt-[18rem] sm:text-5xl xsm:mt-[24rem] xsm:text-4xl xxsm:mt-[24rem] xxsm:text-4xl laptop:mt-[25rem] laptop:text-4xl smLaptop:mt-[26rem] smLaptop:text-4xl tablet:mt-[28rem] tablet:text-xl xlMobile:text-4xl lgMobile:text-xl lgMobile:mt-24 mdMobile:text-xl font-ruda">{landingPageQuote}</h1>
                    ...
                    <div className="flex xlMobile:flex-col xlMobile:-mt-[20rem] lgMobile:flex-col mdMobile:flex-col">
                        <div className="w-[40%] xlMobile:w-[10%] lgMobile:w-[10%] mdMobile:w-[10%] px-32 tablet:px-24 py-56 tablet:py-24 xlMobile:px-12 lgMobile:px-10 mdMobile:px-6 lgMobile:py-24 mdMobile:py-20">
                            <div className="sticky h-[65vh] top-[28vh] xlMobile:hidden lgMobile:hidden mdMobile:hidden">
                                <h2 className={`font-[900] font-ruda text-6xl lgMobile:text-2xl lgMobile:w-[20rem] tablet:text-3xl tablet:w-[15rem] ${darkMode ? 'text-white' : 'text-black'}`}>What We Do</h2>
                                <ul className="text-5xl lgMobile:text-3xl tablet:text-2xl font-[600] font-hind mt-14 tablet:mt-6 text-[#767676]">
                        ...
                        <div className="w-[60%] xlMobile:w-full lgMobile:w-full mdMobile:w-full">
                            ...
                            <div className={`w-full lgMobile:w-[90%] h-screen xlMobile:h-[60rem] p-6 xlMobile:p-0 -ml-6 xlMobile:ml-0 lgMobile:mr-6 mdMobile:-ml-12 tablet:ml-0 mdMobile:pr-10 flex flex-col items-center ${darkMode ? 'text-white' : 'text-black'}`}>
                                ...
                                <p className="w-3/4 font-shanti mt-2 xlMobile:mt-6 text-lg xlMobile:text-2xl tablet:text-sm">Mechanical needs in production are essential, ensuring products are convenient and meet user demands. Elegant designs enhance accessibility and user experience, while durability in different environments guarantee product longevity across various conditions. These elements are fundamental to a product’s success, reflecting the original vision and adapting to market expectations sustainably.</p>
                            </div>
                            <div className={`w-full lgMobile:w-[90%] h-screen xlMobile:h-[50rem] p-6 xlMobile:p-0 xlMobile:ml-0 -ml-6 lgMobile:mr-6 mdMobile:-ml-12 tablet:ml-0 mdMobile:pr-10 flex flex-col items-center ${darkMode ? 'text-white' : 'text-black'}`}>
                                ...
                                <p className="w-3/4 font-shanti mt-2 xlMobile:mt-6 text-lg xlMobile:text-2xl tablet:text-sm">Innovative circuitry is crucial, providing longer battery life and ensuring device functionality aligns with consumer needs. Robust  protections are implemented to extend the device’s lifespan against power surges or voltage harsh situations.</p>
                            </div>
                            <div className={`w-full lgMobile:w-[90%] h-screen xlMobile:h-[55rem] p-6 xlMobile:p-0 xlMobile:ml-0 -ml-6 lgMobile:mr-6 mdMobile:-ml-12 tablet:ml-0 mdMobile:pr-10 flex flex-col items-center ${darkMode ? 'text-white' : 'text-black'}`}>
                                ...
                                <p className="w-3/4 font-shanti mt-2 xlMobile:mt-6 text-lg xlMobile:text-2xl tablet:text-sm">At our core, we are committed to innovation, consistently integrating cutting-edge technology into our software development process. We embrace experimentation and continuously explore new methodologies to enhance performance, ensure scalability, and maintain the utmost reliability in our products.</p>
                            </div>
                            <div className={`w-full lgMobile:w-[90%] h-screen xlMobile:h-[60rem] p-6 xlMobile:p-0 xlMobile:ml-0 -ml-6 lgMobile:mr-6 mdMobile:-ml-12 tablet:ml-0 mdMobile:pr-10 flex flex-col items-center ${darkMode ? 'text-white' : 'text-black'}`}>
                                ...
                                <p className="w-3/4 font-shanti mt-2 xlMobile:mt-6 text-lg xlMobile:text-2xl tablet:text-sm">Manufacturing is a critical process in the product lifecycle, powering the transformation of concepts into market-ready goods. It encompasses design, prototyping, and production, ensuring that ideas are not only realized but optimized for consumer use. The goal is to deliver quality and innovation, seamlessly integrating functionality with user expectations. We manufacture locally in the United States in our own facility as well as overseas depending on costs and demand.</p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full h-screen flex tablet:mt-16 xlMobile:hidden lgMobile:hidden mdMobile:hidden relative">
                        {adminPrivileges && (
                            <button className={`absolute top-[10rem] tablet:top-[7rem] right-[10rem] tablet:right-[2rem] px-6 tablet:px-3 py-2 tablet:py-1 rounded-full border-2 font-semibold tablet:text-sm font-hind ${darkMode ? 'text-white' : 'text-black'}`}
                        ...
                        <div className="w-1/2 flex items-center justify-center py-16 pr-32">
                            <div className={`h-2/3 w-2/3 relative ${darkMode ? 'text-white' : 'text-black'}`}>
                                <h2 className="text-5xl tablet:text-3xl lgMobile:text-3xl mdMobile:text-2xl font-thin font-ruda">Our Products</h2>
                                <h3 className="text-3xl font-hind tablet:text-lg text-[#FF7F11] mt-4">{`${productsPageNames[productNum - 1]}`}</h3>
                                <p className="mt-4 font-shanti tablet:text-sm">{`${productsPageDescriptions[productNum - 1]}`}</p>
                    ...
                    <div className="w-full h-screen flex xlMobile:flex-col lgMobile:flex-col mdMobile:flex-col xlMobile:mt-[10rem] lgMobile:mt-[10rem] mdMobile:mt-[5rem] relative">
                        ...
                        <div className={`w-1/2 xlMobile:w-full lgMobile:w-full mdMobile:w-full flex flex-col justify-center pl-32 xlMobile:pl-12 ${darkMode ? 'text-white' : 'text-black'}`}>
                            <h2 className="text-5xl tablet:text-3xl tablet:-ml-12 lgMobile:-ml-10 mdMobile:-ml-10 font-thin font-hind">Think Tank</h2>
                            <p className="pr-[6em] font-shanti tablet:pr-[3em] xlMobile:pr-6 lgMobile:pr-0 mdMobile:pr-0 tablet:-ml-12 lgMobile:-ml-28 mdMobile:-ml-28 lgMobile:w-full mdMobile:w-full mt-6 text-lg tablet:text-[1rem] xlMobile:text-2xl whitespace-pre-wrap">{thinkTankText}</p>
                        </div>
                    ...
                    <div className="w-full h-screen flex xlMobile:flex-col-reverse lgMobile:flex-col-reverse mdMobile:flex-col-reverse xlMobile:mb-32 lgMobile:mb-32 mdMobile:mb-32 xlMobile:-mt-[20rem] lgMobile:-mt-[15rem] mdMobile:-mt-[15rem]">
                        ...
                        <div className={`w-1/2 xlMobile:w-full lgMobile:w-full mdMobile:w-[90%] flex flex-col justify-center pl-32 tablet:pl-8 xlMobile:pl-12 lgMobile:pl-10 mdMobile:pl-6 xlMobile:mb-10 lgMobile:mb-10 mdMobile:mb-10 ${darkMode ? 'text-white' : 'text-black'}`}>
                            <h2 className="text-5xl tablet:text-3xl font-thin font-hind">About Us</h2>
                            <p className="pr-[6em] tablet:pr-[3em] xlMobile:pr-12 mt-6 text-lg xlMobile:text-2xl font-shanti tablet:text-[1rem]">Interactive Technologies, Inc. is always
