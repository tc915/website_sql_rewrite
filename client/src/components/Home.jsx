                ...
                <motion.div className={`w-full mdMobile:w-[30rem] lgMobile:w-[30rem] overflow-hidden`}>
                    ...
                    <div className="flex lgMobile:flex-col mdMobile:flex-col">
                        ...
                        <div className="w-[60%] lgMobile:w-full mdMobile:w-full">
                            <h2 className={`lgMobile:block mdMobile:block hidden font-semibold text-3xl w-full text-center lgMobile:-ml-[6.2rem] mdMobile:-ml-[9rem] -mb-24 ${darkMode ? 'text-white' : 'text-black'}`}>What We Do</h2>
