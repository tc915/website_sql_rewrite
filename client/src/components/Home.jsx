...
const Home = ({ scrollY }) => {
    ...
    return (
        <>
            ...
            <motion.div className={`relative w-full lgMobile:pt-[12rem] ${darkMode ? 'bg-[#131313]' : 'bg-white'} overflow-x-hidden`}
                variants={fadeInVariants}
                initial="initial"
                animate="animate"
            >
                <motion.div className={`w-full mdMobile:w-[30rem] lgMobile:w-[30rem] overflow-hidden`}>
                    ...
                    <div className="w-full h-[20rem] absolute -mt-[52rem] lgMobile:-mt-[36rem] lgMobile:w-[85%] text-white pl-[9.5rem] xsm:pl-[7rem] xxsm:pl-[7rem] laptop:pl-[7rem] smLaptop:pl-[5rem] tablet:pl-[5rem] lgMobile:pl-[3rem] mdMobile:pl-[3rem] mdMobile:pr-[5rem] mdMobile:w-full mdMobile:-mt-[30rem]">
                        ...
                        <div className="flex mt-16 lgMobile:mt-8 lgMobile:flex-col">
                            <Link to={'/contact'}><motion.button className="py-2 px-10 lgMobile:py-2 lgMobile:px-8 mdMobile:px-10 text-xl lgMobile:text-xl mdMobile:text-[0.5rem] font-semibold rounded-full bg-[#FF7F11]"
                                variants={buttonVariants}
                                whileHover="hover"
                                whileTap="click"
                            >Start a Project</motion.button></Link>
                            <Link to={'/products'}><motion.button className="py-2 px-6 lgMobile:py-2 lgMobile:px-8 mdMobile:px-10 ml-8 lgMobile:ml-0 lgMobile:mt-6 text-xl lgMobile:text-lg mdMobile:text-[0.5rem] font-semibold rounded-full border-2 border-white"
                                variants={buttonVariants}
                                whileHover="hover"
                                whileTap="click"
                    ...
                    <div className="w-full h-screen flex lgMobile:hidden relative">
                        {adminPrivileges && (
                        ...
                        <div className="w-1/2 flex lgMobile:flex-col items-center justify-center py-16 pr-32">
                            <div className={`h-2/3 w-2/3 relative ${darkMode ? 'text-white' : 'text-black'}`}>
                                <h2 className="text-5xl lgMobile:text-3xl font-thin">Our Products</h2>
                    ...
                    <div className="w-full h-screen flex lgMobile:flex-col lgMobile:mt-[5rem]">
                        <div className={`w-1/2 lgMobile:w-full flex flex-col justify-center pl-32 ${darkMode ? 'text-white' : 'text-black'} relative`}>
                            ...
                            >Edit</button>
                            <h2 className="text-5xl lgMobile:-ml-10 font-thin">Think Tank</h2>
                            <p className="pr-[6em] lgMobile:pr-0 lgMobile:-ml-28 lgMobile:w-full mt-6 text-lg whitespace-pre-wrap">{thinkTankText}</p>
                        </div>
                        <div className="w-1/2 lgMobile:w-full lgMobile:px-4 lgMobile:h-[35rem] lgMobile:-mt-14 flex justify-center items-center">
