...
const ProductDetails = () => {
    ...
    return (
        <div className={`pt-40 lgMobile:py-56 mdMobile:py-56 lgMobile:pb-24 mdMobile:pb-24 ${darkMode ? 'text-white bg-[#131313]' : 'text-black bg-white'}`}>
            <div className="w-full h-[40rem] p-10 flex lgMobile:flex-col mdMobile:flex-col relative px-[15rem] lgMobile:px-6 mdMobile:px-6 mb-44">
                {adminPrivileges && (
                    <button className="absolute top-4 right-[17rem] px-10 border-[3px] border-gray-300 rounded-xl font-semibold"
                        onClick={() => setShowEdit(true)}
                    >Edit</button>
                )}
                <div className="h-full w-1/2 lgMobile:w-full mdMobile:w-full flex justify-center lgMobile:mt-10 mdMobile:mt-10">
                ...
                <div className="h-full w-1/2 lgMobile:w-full mdMobile:w-full ml-10 lgMobile:ml-0 mdMobile:ml-0 p-10 lgMobile:p-6 mdMobile:p-6">
                    <h1 className="text-4xl lgMobile:text-2xl mdMobile:text-2xl font-bold pb-4">{product.name}</h1>
                    <p className="text-4xl lgMobile:text-2xl mdMobile:text-2xl font-semibold mb-6">${displayPrice}</p>
                    ...
                    <div className="w-full h-[15rem] mdMobile:h-[25rem] py-6 pr-4 rounded-xl overflow-y-auto overflow-x-hidden whitespace-pre-wrap text-2xl">{product.description}</div>
                </div>
                <div className="lgMobile:mt-44 mdMobile:mt-44 lgMobile:w-full mdMobile:w-full lgMobile:-translate-x-8 mdMobile:-translate-x-8 lgMobile:block mdMobile:block hidden">
                    <Footer />
                </div>
            </div>
            ...
            <div className={`fixed top-0 left-0 w-full h-full ${darkMode ? 'text-white' : 'text-black'} bg-black/50 z-[99] ${showEdit ? 'flex justify-center items-center' : 'hidden'}`}>
                <div className={`w-2/3 lgMobile:w-[90%] mdMobile:w-[90%] h-[85%] ${darkMode ? 'bg-[#131313]' : 'bg-white'} border-4 border-[#FF7F11] rounded-3xl flex flex-col items-center p-12 overflow-y-auto scroll-p-5 relative`}>
                    ...
                    >
                        ...
                        <div className='w-2/3 lgMobile:w-full mdMobile:w-full flex flex-col'>
                            {variablePricing && variablePricing.length > 0 && variablePricing.map((price, index) => (
                                <div key={index} className='flex relative'>
                                    ...
                                    <div className={`py-2 lgMobile:px-2 mdMobile:px-2 px-4 font-semibold text-xl lgMobile:text-sm mdMobile:text-xl lgMobile:flex mdMo   flex lgMobile:justify-center mdMobile:justify-center lgMobile:items-center mdMobile:items-center mb-4 ${darkMode ? 'bg-white text-black' : 'bg-[#131313]/80 text-white'} w-1/2 rounded-full`}>{`Price: $${price.price}`}</div>
                        ...
                        <div className="w-full flex lgMobile:flex-col mdMobile:flex-col items-center">
                            <label htmlFor="fileUploadThumbnail" className={`bg-transparent border-4 border-[#FF7F11] p-4 w-1/4 lgMobile:w-full mdMobile:w-full rounded-xl self-start ml-[11rem] lgMobile:ml-0 mt-2 h-[4rem] ${darkMode ? 'text-white' : 'text-black'} font-bold text-2xl lgMobile:text-xl mdMobile:text-xl flex justify-center items-center cursor-pointer`}>{fileInputThumbnailText}</label>
