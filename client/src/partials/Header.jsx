...
const Header = () => {
    ...
    return (
        <motion.header
            className={`flex justify-between items-center h-[8em] lgMobile:h-[12rem] lgMobile:w-[100vw] p-2 w-[100vw] z-[10] fixed bg-black`}>
            ...
            <Link as={NavLink} to={'/'} className="text-4xl font-bold ml-[2rem] text-white">
                <img className="2xl:w-[28%] xl:w-[32%] lg:w-[35%] md:w-[40%] sm:w-[50%] xsm:w-[50%] xxsm:w-[45%] xxsm:mt-4 laptop:w-[50%] smLaptop:w-[50%] smLaptop:mt-4 laptop:mt-4 tablet:w-[25%] lgMobile:w-[50%]" src="/iTi_logo_color.png" />
            </Link>
            <nav className="mt-10">
                <ul className={`text-xl xl:text-lg xsm:text-[1.15rem] xxsm:text-[1.05rem] laptop:text-[1rem] smLaptop:text-[0.95rem] ${user ? 'mr-[14rem]' : '2xl:mr-[15rem] xl:mr-[13rem] lg:mr-[12rem] md:mr-[7rem] sm:mr-[4rem] xsm:mr-[5rem] xxsm:mr-[3rem] laptop:mr-[2.6rem] smLaptop:mr-[3rem]'} rounded-3xl flex tablet:hidden lgMobile:hidden`}>
            ...
            <div className="flex items-center mt-10 mr-5 text-white">
                <div className="font-semibold flex items-center mr-[3rem] laptop:mr-[1.5rem] text-2xl xl:text-xl tablet:mb-6 lgMobile:mb-6 text-nowrap relative">
                    {user && (
                        <>
                            <motion.button className="lg:text-xl md:text-[1.32rem] sm:text-[1.3rem] xsm:text-[1.2rem] xxsm:text-[1.2rem] laptop:text-[1.2rem] smLaptop:text-[1.17rem] tablet:text-[1.15rem] lgMobile:hidden"
                            ...
                            <Link as={NavLink} to={`/${user.username}/info`}>
                                <svg className="ml-4 pointer-events-none 2xl:w-[60px] 2xl:h-[60px] xl:w-[48px] xl:h-[48px] lg:w-[48px] lg:h-[48px] md:w-[44px] md:h-[44px] sm:w-[40px] sm:h-[40px] xsm:w-[40px] xsm:h-[40px] xxsm:w-[38px] xxsm:h-[38px] laptop:w-[36px] smLaptop:w-[34px] tablet:w-[35px] lgMobile:hidden" xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 -960 960 960" width="50px" fill="#FFFFFF"><path d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Z" /></svg>
                            </Link>
                    ...
                    <button className="ml-2 bg-[#333333] rounded-full p-1 lgMobile:hidden"
                        onClick={() => setDarkMode(!darkMode)}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#ffd817" className={`${darkMode ? 'hidden' : ''} 2xl:w-[48px] 2xl:h-[48px] xl:w-[42px] xl:h-[42px] lg:w-[40px] lg:h-[40px] md:w-[37px] md:h-[37px] sm:w-[35px] sm:h-[35px] xsm:w-[32px] xsm:h-[32px] xxsm:w-[32px] xxsm:h-[32px] laptop:w-[30px] smLaptop:w-[28px] tablet:w-[25px] tablet:h-[25px] lgMobile:hidden`}><path d="M450-770v-150h60v150h-60Zm256 106-42-42 106-107 42 43-106 106Zm64 214v-60h150v60H770ZM450-40v-150h60v150h-60ZM253-665 148-770l42-42 106 106-43 41Zm518 517L664-254l41-41 108 104-42 43ZM40-450v-60h150v60H40Zm151 302-43-42 105-105 22 20 22 21-106 106Zm289-92q-100 0-170-70t-70-170q0-100 70-170t170-70q100 0 170 70t70 170q0 100-70 170t-170 70Z" /></svg>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="48px" fill="#FFFFFF" className={`${darkMode ? '' : 'hidden'} 2xl:w-[48px] 2xl:h-[48px] xl:w-[42px] xl:h-[42px] lg:w-[40px] lg:h-[40px] md:w-[37px] md:h-[37px] sm:w-[35px] sm:h-[35px] xsm:w-[32px] xsm:h-[32px] xxsm:w-[32px] xxsm:h-[32px] laptop:w-[30px] smLaptop:w-[28px] tablet:w-[25px] tablet:h-[25px] lgMobile:hidden`}><path d="M480-120q-150 0-255-105T120-480q0-150 105-255t255-105q8 0 17 .5t23 1.5q-36 32-56 79t-20 99q0 90 63 153t153 63q52 0 99-18.5t79-51.5q1 12 1.5 19.5t.5 14.5q0 150-105 255T480-120Z" /></svg>
                    </button>
                    <button className="ml-2 -mr-6 tablet:block lgMobile:block hidden"
                        onClick={() => setHamburgerNavOpen(!hamburgerNavOpen)}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className={`tablet:w-[35px] lgMobile:w-[50px] ${hamburgerNavOpen ? 'hidden' : ''}`} viewBox="0 -960 960 960" fill="#FFFFFF"><path d="M120-240v-66.67h720V-240H120Zm0-206.67v-66.66h720v66.66H120Zm0-206.66V-720h720v66.67H120Z" /></svg>
                        <svg xmlns="http://www.w3.org/2000/svg" className={`tablet:w-[35px] lgMobile:w-[50px] ${hamburgerNavOpen ? '' : 'hidden'}`} viewBox="0 -960 960 960" fill="#fff"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z" /></svg>
                    </button>
                    <div className={`absolute bg-black w-[12rem] h-[14rem] lgMobile:w-[25.2rem] -left-[19.2rem] lgMobile:h-[100vh] top-[7rem] flex flex-col items-center ${hamburgerNavOpen ? '' : 'hidden'}`}>
