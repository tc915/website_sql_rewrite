        ...
        <motion.header
            ...
            <div className={`absolute top-0 left-0 z-[99] bg-black/50 w-full h-screen ${isLogoutPopup ? '' : 'hidden'} flex justify-center items-center`}>
                <div className="text-white rounded-lg bg-black border-4 border-[#FF7F11] w-1/4 lgMobile:w-2/3 mdMobile:w-2/3 h-1/6 px-24 lgMobile:px-14 mdMobile:px-14 py-4 flex flex-col items-center justify-center relative">
                    ...
                    <button className="bg-white lgMobile:p-2 mdMobile:p-2 text-lg w-full text-gray-800 font-bold rounded-lg mt-4"
                        onClick={() => {
                            logout();
            ...
            <div className="flex items-center mt-10 mr-5 text-white">
                <div className="font-semibold flex items-center mr-[3rem] laptop:mr-[1.5rem] text-2xl xl:text-xl tablet:mb-6 lgMobile:mb-6 text-nowrap relative">
                    ...
                    <div className={`absolute tablet:top-[3.1rem] tablet:-right-[4.75rem] tablet:h-[15rem] tablet:w-[16rem] tablet:pt-2 bg-black lgMobile:w-[30rem] mdMobile:w-[30rem] lgMobile:-left-[20.25rem] mdMobile:-left-[20.25rem] lgMobile:h-[100vh] mdMobile:h-[100vh] top-[7rem] mdMobile:top-14 mdMobile:pt-10 flex flex-col items-center ${hamburgerNavOpen ? 'tablet:block lgMobile:block mdMobile:block' : 'hidden'}`}>
                        <ul className="text-center tablet:text-[1.5rem] lgMobile:text-[1.75rem]">
                            {user && (
