    ...
    return (
        <motion.header
            ...
            <Link as={NavLink} to={'/'} className="text-4xl font-bold ml-[2rem] text-white">
                <img className="2xl:w-[28%] xl:w-[32%] lg:w-[35%] md:w-[40%] sm:w-[50%] xsm:w-[50%] xxsm:w-[45%] xxsm:mt-4 laptop:w-[50%] smLaptop:w-[50%] smLaptop:mt-4 laptop:mt-4 tablet:w-[25%] lgMobile:w-[35%]" src="/iTi_logo_color.png" />
            </Link>
            <nav className="mt-10">
            ...
            <div className="flex items-center mt-10 mr-5 text-white">
                <div className="font-semibold flex items-center mr-[3rem] laptop:mr-[1.5rem] text-2xl xl:text-xl tablet:mb-6 lgMobile:mb-6 text-nowrap relative">
                    ...
                    <button className="tablet:ml-2 -mr-10 tablet:block lgMobile:block hidden"
                        onClick={() => setHamburgerNavOpen(!hamburgerNavOpen)}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className={`tablet:w-[35px] lgMobile:w-[35px] ${hamburgerNavOpen ? 'hidden' : ''}`} viewBox="0 -960 960 960" fill="#FFFFFF"><path d="M120-240v-66.67h720V-240H120Zm0-206.67v-66.66h720v66.66H120Zm0-206.66V-720h720v66.67H120Z" /></svg>
                        <svg xmlns="http://www.w3.org/2000/svg" className={`tablet:w-[35px] ${hamburgerNavOpen ? '' : 'hidden'}`} viewBox="0 -960 960 960" fill="#fff"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z" /></svg>
                    </button>
                    <div className={`absolute bg-black w-[12rem] h-[14rem] -right-20 top-[3.8rem] flex flex-col items-end ${hamburgerNavOpen ? '' : 'hidden'}`}>
                        <ul className="text-right -mr-4">
                            <Link as={NavLink} to={'/services'}>
                                <motion.li className={`mr-8 mb-2 xl:mr-10`}
                                    style={{ color: location.pathname === '/services' ? '#FF7F11' : '#fff' }}
                                    variants={navVariants}
                                    whileHover="hover"
                                    whileTap="click"
