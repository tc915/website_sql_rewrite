...
const Header = () => {
    ...
    return (
        <motion.header
            className={`flex justify-between items-center h-[8em] lgMobile:h-[15rem] p-2 w-full z-[10] fixed bg-black`}>
                ...
                <div className="font-semibold flex items-center mr-[3rem] laptop:mr-[1.5rem] text-2xl xl:text-xl tablet:mb-6 lgMobile:mb-6 text-nowrap relative">
                    ...
                    <div className={`absolute bg-black w-[12rem] h-[14rem] lgMobile:w-[18rem] lgMobile:h-[20rem] -right-20 top-[8.7rem] flex flex-col items-end ${hamburgerNavOpen ? '' : 'hidden'}`}>
                        <ul className="text-right -mr-4 lgMobile:text-[2rem]">
                            ...
                            <Link as={NavLink} to={'/about'}>
                                <motion.li className={`mr-8 xl:mr-10 text-nowrap lgMobile:mb-6`}
                                    style={{ color: location.pathname === '/about' ? '#FF7F11' : '#fff' }}
                                    variants={navVariants}
                                    whileHover="hover"
                                    whileTap="click"
