        ...
        <motion.header
            ...
            <div className="flex items-center mt-10 mr-5 text-white">
                <div className="font-semibold flex items-center mr-[3rem] laptop:mr-[1.5rem] text-2xl xl:text-xl tablet:mb-6 lgMobile:mb-6 text-nowrap relative">
                    ...
                    <div className={`absolute tablet:top-[4.5rem] tablet:-right-[4.75rem] tablet:h-[15rem] tablet:w-[16rem] tablet:pt-2 bg-black lgMobile:w-[30rem] lgMobile:-left-[20.1rem] lgMobile:h-[100vh] top-[7rem] flex flex-col items-center ${hamburgerNavOpen ? 'tablet:block lgMobile:block mdMobile:block' : 'hidden'}`}>
