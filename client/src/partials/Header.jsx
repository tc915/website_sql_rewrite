    ...
    return (
        <motion.header
            ...
            <div className={`absolute top-0 left-0 z-[99] bg-black/50 w-full h-screen ${isLogoutPopup ? '' : 'hidden'} flex justify-center items-center`}>
                <div className="text-white rounded-lg bg-black border-4 border-[#FF7F11] w-1/4 lgMobile:w-2/3 h-1/6 px-24 lgMobile:px-14 py-4 flex flex-col items-center justify-center relative">
                    <p className="text-2xl lgMobile:text-lg font-semibold">Log out?</p>
                    <button className="bg-white lgMobile:p-2 text-lg w-full text-gray-800 font-bold rounded-lg mt-4"
                        onClick={() => {
                            logout();
            ...
            <div className="flex items-center mt-10 mr-5 text-white">
                <div className="font-semibold flex items-center mr-[3rem] laptop:mr-[1.5rem] text-2xl xl:text-xl tablet:mb-6 lgMobile:mb-6 text-nowrap relative">
                    ...
                    <div className={`absolute tablet:top-[4.5rem] tablet:-right-[4.75rem] tablet:h-[15rem] tablet:w-[16rem] tablet:pt-2 bg-black lgMobile:w-[30rem] mdMobile:w-[30rem] lgMobile:-left-[20.25rem] mdMobile:-left-[20.25rem] lgMobile:h-[100vh] mdMobile:h-[100vh] top-[7rem] mdMobile:top-14 mdMobile:pt-10 flex flex-col items-center ${hamburgerNavOpen ? 'tablet:block lgMobile:block mdMobile:block' : 'hidden'}`}>
                        <ul className="text-center tablet:text-[2rem] lgMobile:text-[1.75rem]">
                            ...
                            {!user && (
                                <div className="flex items-center justify-center mb-4 tablet:hidden">
                                    ...
                                    >Login</Link>
                                    <svg className="ml-2 tablet:w-[35px] lgMobile:w-[50px] mdMobile:w-[50px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="#FFFFFF"><path d="M480-481q-66 0-108-42t-42-108q0-66 42-108t108-42q66 0 108 42t42 108q0 66-42 108t-108 42ZM160-160v-94q0-38 19-65t49-41q67-30 128.5-45T480-420q62 0 123 15.5t127.92 44.69q31.3 14.13 50.19 40.97Q800-292 800-254v94H160Zm60-60h520v-34q0-16-9.5-30.5T707-306q-64-31-117-42.5T480-360q-57 0-111 11.5T252-306q-14 7-23 21.5t-9 30.5v34Zm260-321q39 0 64.5-25.5T570-631q0-39-25.5-64.5T480-721q-39 0-64.5 25.5T390-631q0 39 25.5 64.5T480-541Zm0-90Zm0 411Z" /></svg>
                                </div>
                            )}
                            <Link as={NavLink} to={'/services'}>
