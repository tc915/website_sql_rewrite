    ...
    return (
        <motion.header
            ...
            <Link as={NavLink} to={'/'} className="text-4xl font-bold ml-[2rem] text-white">
                <img className="2xl:w-[28%] xl:w-[32%] lg:w-[35%] md:w-[40%] sm:w-[50%] xsm:w-[50%] xxsm:w-[45%] xxsm:mt-4 laptop:w-[50%] smLaptop:w-[50%] smLaptop:mt-4 laptop:mt-4 tablet:w-[25%] lgMobile:w-[65%]" src="/iTi_logo_color.png" />
            </Link>
            <nav className="mt-10">
            ...
            <div className="flex items-center mt-10 mr-5 text-white">
                <div className="font-semibold flex items-center mr-[3rem] laptop:mr-[1.5rem] text-2xl xl:text-xl tablet:mb-6 lgMobile:mb-6 text-nowrap relative">
                    ...
                    {!user && (
                        <>
                            <Link as={NavLink} to='/login' className="lg:text-xl md:text-[1.32rem] sm:text-[1.3rem] xsm:text-[1.2rem] xxsm:text-[1.2rem] laptop:text-[1.2rem] smLaptop:text-[1.17rem] tablet:text-[1.15rem] lgMobile:text-[1.8rem]">Login</Link>
