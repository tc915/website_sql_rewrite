...
const ServicesNav = ({ location }) => {
    ...
    return (
        <div className={`border-b-4 w-full h-[5rem] ${darkMode ? 'text-white' : 'text-black'} text-xl tablet:text-sm lgMobile:text-[1rem] lgMobile:mt-4 font-bold py-1 tablet:px-6 flex items-center justify-center font-hind`}>
