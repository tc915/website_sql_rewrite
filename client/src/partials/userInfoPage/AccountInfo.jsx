    ...
    return (
        ...
        >
            ...
            <div className="w-full h-[5rem] mt-6 flex items-center px-24 rounded-2xl border-2">
                ...
                />
                <button className={`${isChangeEmail ? 'hidden' : ''} border-4 border-[#FF7F11] px-10 py-2 text-xl ${darkMode ? 'text-white' : 'text-black'} font-semibold rounded-full ml-auto`}
                    onClick={(ev) => {
                        ev.preventDefault();
            ...
            <div className="w-full h-[5rem] mt-6 flex items-center px-24 rounded-2xl border-2">
                <label htmlFor="userPassword" className="text-xl font-semibold mr-4">Password:</label>
                <button className={`${isChangePassword ? 'hidden' : ''} border-4 border-[#FF7F11] px-6 rounded-full text-xl font-semibold ${darkMode ? 'text-white' : 'text-black'} py-2 ml-auto`}
                    onClick={(ev) => {
                        ev.preventDefault();
