...
const Footer = () => {
    return (
        <footer className="w-full lgMobile:w-full mdMobile:w-full h-[5rem] lgMobile:h-[15rem] mdMobile:h-[15rem] bg-black text-white font-semibold text-xl lgMobile:text-[0.8rem] mdMobile:text-[0.8rem] flex lgMobile:flex-col mdMobile:flex-col items-center lgMobile:items-start mdMobile:items-start p-6">
